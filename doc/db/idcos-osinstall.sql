...
INSERT INTO `os_configs` VALUES (2,'2015-11-24 08:00:44','2015-12-10 03:09:07',NULL,'centos6u7-x86_64','DEFAULT centos6.7\nLABEL centos6.7\nKERNEL http://osinstall.idcos.net/centos/6.7/os/x86_64/images/pxeboot/vmlinuz\nAPPEND initrd=http://osinstall.idcos.net/centos/6.7/os/x86_64/images/pxeboot/initrd.img ksdevice=bootif ks=http://osinstall.idcos.net/api/osinstall/v1/device/getSystemBySn?sn={sn} console=tty0 console=ttyS1,115200 selinux=0 biosdevname=0\nIPAPPEND 2'),(30,'2015-12-08 09:41:50','2015-12-10 03:10:24',NULL,'sles11sp4-x86_64','DEFAULT sles11sp4\nLABEL sles11sp4\nKERNEL http://osinstall.idcos.net/sles/11sp4/os/x86_64/boot/x86_64/loader/linux\nAPPEND initrd=http://osinstall.idcos.net/sles/11sp4/os/x86_64/boot/x86_64/loader/initrd netdevice=bootif install=http://osinstall.idcos.net/sles/11sp4/os/x86_64/ autoyast=http://osinstall.idcos.net/api/osinstall/v1/device/getSystemBySn?sn={sn} console=tty0 console=ttyS1,115200 selinux=0 biosdevname=0 textmode=1\nIPAPPEND 2'),(31,'2015-12-09 07:37:03','2015-12-10 03:11:13',NULL,'rhel7u2-x86_64','DEFAULT rhel7.2\nLABEL rhel7.2\nKERNEL http://osinstall.idcos.net/rhel/7.2/os/x86_64/images/pxeboot/vmlinuz\nAPPEND initrd=http://osinstall.idcos.net/rhel/7.2/os/x86_64/images/pxeboot/initrd.img ksdevice=bootif ks=http://osinstall.idcos.net/api/osinstall/v1/device/getSystemBySn?sn={sn} console=tty0 console=ttyS1,115200 selinux=0 net.ifnames=0 biosdevname=0\nIPAPPEND 2');
